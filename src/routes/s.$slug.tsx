...
import type { StoreConfig, TemplateId, DesignStyle } from "@/lib/store-config";
  ...
  errorComponent: () => (
    <div className="grid min-h-screen place-items-center bg-canvas p-8 text-center">
      <div>
        ...
        <h1 className="mt-2 font-serif text-3xl italic">Something went wrong loading this store.</h1>
  ...
  return (
    <div className="min-h-screen bg-stone-100">
      ...
      <div className="py-6 text-center text-[10px] uppercase tracking-widest text-ink/40">
        Powered by Atelier · <Link to="/" className="underline">Create your own store</Link>
      </div>
    </div>
  );
}
