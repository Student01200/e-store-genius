...
export const Route = createFileRoute("/auth")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Sign in or create your Atelier account to start generating stores.",
      },
      ...
      <main className="mx-auto grid max-w-7xl grid-cols-1 gap-16 px-6 py-12 lg:grid-cols-2 lg:py-24">
        <div className="hidden flex-col justify-center lg:flex">
          ...
          <p className="mt-6 max-w-md text-sm leading-relaxed text-ink/60">
            Every store you generate, every template you save, every draft you leave — waiting
          ...
          <div className="mx-auto w-full max-w-sm">
            ...
            >
              <svg viewBox="0 0 24 24" className="size-4" aria-hidden>
                <path
                  fill="#4285F4"
                  d="M22.5 12.3c0-.8-.1-1.4-.2-2.1H12v3.9h5.9c-.1 1-.8 2.6-2.3 3.6l3.4 2.6c2-1.9 3.5-4.7 3.5-8z"
                />
                <path
                  fill="#34A853"
                  d="M12 23c3 0 5.6-1 7.4-2.7l-3.4-2.6c-1 .6-2.2 1.1-4 1.1-3 0-5.6-2-6.5-4.8L2 16.6C3.8 20.4 7.6 23 12 23z"
                />
                <path
                  fill="#FBBC05"
                  d="M5.5 14c-.2-.6-.4-1.3-.4-2s.1-1.4.4-2L2 7.4C1.4 8.8 1 10.3 1 12s.4 3.2 1 4.6l3.5-2.6z"
                />
                <path
                  fill="#EA4335"
                  d="M12 5.4c1.7 0 2.9.7 3.6 1.3L18.6 4c-1.8-1.6-4-2.7-6.6-2.7C7.6 1.3 3.8 3.9 2 7.4l3.5 2.6C6.4 7.3 9 5.4 12 5.4z"
                />
              </svg>
            ...
            <div className="mb-6 flex items-center gap-3 text-[10px] uppercase tracking-widest text-ink/30">
              <span className="h-px flex-1 bg-ink/10" /> or email{" "}
